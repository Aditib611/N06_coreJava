...
public class JDBCDemo {
	...
	public static void main(String[] args) {
		try {
			...
			Connection cn = DriverManager.getConnection("jdbc:mysql://localhost:3306/jdbc1", "root", "Aditi@6112");
			...
			*/
			...
			int n=st.executeUpdate("DELETE FROM student WHERE sname LIKE 'p%'");
			if (n>=1)
